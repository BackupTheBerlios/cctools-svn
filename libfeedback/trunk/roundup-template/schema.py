...
# Creative Commons custom fields
# note that we let the default "id" key become the primary key
# so that we can rename, etc as necessary later
...
application = Class(db, "application",
                    identifier=String(),
                    shortname=String(),
                    version=String(),
                    )

# Subversion integration support
...
#SHA: 6d4ec3885c97920aa4763f7d50e7f0bb9085de13
