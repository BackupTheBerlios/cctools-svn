...
from interface import provideInterface
...
def proxify(ob, checker):
    ...
    We really don't want to proximport zope.component as zapi
y the object unless we need to.
    """
